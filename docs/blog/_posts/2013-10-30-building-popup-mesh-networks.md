...
lang: en
---
  <img alt="" class="media-image attr__typeof__foaf:Image img__fid__548 img__view_mode__media_large attr__format__media_large" height="222" src="{{site.baseurl}}/files/styles/large/public/title_image.png?itok=uhJC0pqH" typeof="foaf:Image" width="480" />
...
<img alt="" class="media-image attr__typeof__foaf:Image img__fid__561 img__view_mode__media_large attr__format__media_large" height="161" src="{{site.baseurl}}/files/styles/large/public/equipment_0.png?itok=HPlApBYr" typeof="foaf:Image" width="480" />
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 427px;" width="427px">
	<tbody>
		<tr>
			<td width="300px"><img alt="" class="media-image attr__typeof__foaf:Image img__fid__549 img__view_mode__media_large attr__format__media_large" src="{{site.baseurl}}/files/styles/large/public/p2p.png?itok=SZDHeK_0" style="width: 300px; height: 211px;" typeof="foaf:Image" /></td>
			<td width="127px"><img alt="" class="media-image attr__typeof__foaf:Image img__fid__559 img__view_mode__media_large attr__format__media_large" src="{{site.baseurl}}/files/styles/large/public/Screenshot_2013-10-29-13-30-11_0.png?itok=E5zClkvu" style="width: 127px; height: 211px;" typeof="foaf:Image" /></td>
		</tr>
	</tbody>
</table>
...
<img alt="" class="media-image attr__typeof__foaf:Image img__fid__551 img__view_mode__media_large attr__format__media_large" height="294" src="{{site.baseurl}}/files/styles/large/public/map2.png?itok=n-xrL_wd" typeof="foaf:Image" width="389" />
...
<img alt="" class="media-image attr__typeof__foaf:Image img__fid__552 img__view_mode__media_large attr__format__media_large" height="319" src="{{site.baseurl}}/files/styles/large/public/map3.png?itok=Z-XI2qdf" typeof="foaf:Image" width="390" /> 
...
<img alt="" class="media-image attr__typeof__foaf:Image img__fid__553 img__view_mode__media_large attr__format__media_large" height="276" src="{{site.baseurl}}/files/styles/large/public/olsrviz4.png?itok=hYCCbEeN" typeof="foaf:Image" width="475" />
...
<img alt="" class="media-image attr__typeof__foaf:Image img__fid__554 img__view_mode__media_large attr__format__media_large" height="240" src="{{site.baseurl}}/files/styles/large/public/olsrviz6.png?itok=RtTLCP_Y" typeof="foaf:Image" width="480" />
...
<img alt="" class="media-image attr__typeof__foaf:Image img__fid__555 img__view_mode__media_large attr__format__media_large" height="216" src="{{site.baseurl}}/files/styles/large/public/olsrviz7.png?itok=oxbB0fsK" typeof="foaf:Image" width="480" />
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 338px;" width="338px">
	<tbody>
		<tr>
			<td width="169px"><i><img alt="" class="media-image attr__typeof__foaf:Image img__fid__556 img__view_mode__media_large attr__format__media_large" src="{{site.baseurl}}/files/styles/large/public/mediagrid1.png?itok=XYdP47ke" style="width: 169px; height: 300px;" typeof="foaf:Image" /></i></td>
			<td width="169px"><i><img alt="" class="media-image attr__typeof__foaf:Image img__fid__558 img__view_mode__media_large attr__format__media_large" src="{{site.baseurl}}/files/styles/large/public/mediagrid2_0.png?itok=-5kIuikp" style="width: 169px; height: 300px;" typeof="foaf:Image" /></i></td>
		</tr>
	</tbody>
</table>
