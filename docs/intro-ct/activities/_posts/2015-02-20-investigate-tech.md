...
<p>Communities have defined community technology in many different ways and with many different projects. One way we have thought about is that community technology is a principled approach to technology that is grounded in the struggle for a more just digital ecosystem, placing value on equity, participation, common ownership and sustainability. In this module participants will use social analysis to understand technologies they use.</p>
...
<p><strong>Profit and Sustainability</strong> <br>
...
<p><strong>Community (wireless) networks</strong> <br>
